...
describe('DataServiceOrchestrator', () => {
    ...
    beforeEach(() => {
        ...
        mockStatsCan = new StatsCanDataSource_1.StatsCanDataSource('test-key');
        mockCMHC = new CMHCDataSource_1.CMHCDataSource('test-key');
        mockBankOfCanada = new BankOfCanadaDataSource_1.BankOfCanadaDataSource('test-key');
        // Mock the constructor calls
        StatsCanDataSource_1.StatsCanDataSource.mockImplementation(() => mockStatsCan);
        CMHCDataSource_1.CMHCDataSource.mockImplementation(() => mockCMHC);
        BankOfCanadaDataSource_1.BankOfCanadaDataSource.mockImplementation(() => mockBankOfCanada);
        ...
        orchestrator = new DataServiceOrchestrator_1.DataServiceOrchestrator();
    });
    describe('Initialization', () => {
        it('should initialize successfully with all data sources', async () => {
            // Mock the data source manager methods
            const mockDataSourceManager = orchestrator['dataSourceManager'];
    ...
    describe('System Monitoring', () => {
        ...
        it('should provide detailed health status for all sources', () => {
            ...
            Object.values(detailedHealth).forEach((sourceHealth) => {
    ...
    describe('Error Handling', () => {
        ...
        it('should throw error when trying to use uninitialized orchestrator', () => {
            const uninitializedOrchestrator = new DataServiceOrchestrator_1.DataServiceOrchestrator();
        ...
        it('should handle validation failures gracefully', async () => {
            ...
            const mockValidationService = orchestrator['validationService'];
    ...
    describe('Performance and Scalability', () => {
        ...
        it('should handle concurrent requests efficiently', async () => {
            ...
            const promises = Array(10).fill(null).map(() => orchestrator.getHousingData(mockLocation));
...
//# sourceMappingURL=DataServiceOrchestrator.test.js.map