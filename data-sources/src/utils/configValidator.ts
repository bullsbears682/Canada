...
export class ConfigValidator {
   ...
   */
  static getConfigurationSummary(): { required: string[]; optional: string[]; missing: string[] } {
   ...
   */
  static getHealthCheckConfig(): { enabled: boolean; interval: number; timeout: number } {
    return {
