 ...
 */
export function getDataSourceConfig(sourceName: string): DataSourceConfig | null {
  return DATA_SOURCE_CONFIGS[sourceName] || null;
}
...
export function getAllDataSourceNames(): string[] {
  return Object.keys(DATA_SOURCE_CONFIGS);
}

/**
 * Get high priority data sources
 */
export function getHighPriorityDataSources(): string[] {
  return Object.entries(DATA_SOURCE_CONFIGS)
 ...
 */
export function getDataSourcesByFrequency(frequency: UpdateFrequency): string[] {
  return Object.entries(DATA_SOURCE_CONFIGS)
