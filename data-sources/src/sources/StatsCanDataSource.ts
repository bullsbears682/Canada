 ...
 */
export class StatsCanDataSource implements DataSource {
  public readonly name = 'Statistics Canada';
  public readonly baseUrl = 'https://api.statcan.gc.ca';
   ...
   */
  async getHousingData(postalCode: string): Promise<HousingData> {
   ...
   */
  async getHousingMarketData(region: string): Promise<HousingData[]> {
   ...
   */
  async getCPIData(): Promise<EconomicIndicators> {
   ...
   * Get employment data
   */
  async getEmploymentData(): Promise<EconomicIndicators> {
   ...
   */
  async getPostalCodeData(postalCode: string): Promise<PostalCodeData> {
   ...
   */
  async getDemographicData(region: string): Promise<any> {
   ...
   */
  async getIncomeData(region: string): Promise<any> {
   ...
   */
  private transformHousingResponse(response: any, postalCode: string): HousingData {
   ...
   */
  private transformMarketResponse(response: any, region: string): HousingData[] {
    const data = response.data || response;
   ...
   */
  private transformCPIResponse(response: any): EconomicIndicators {
    const data = response.data || response;
   ...
   */
  private transformEmploymentResponse(response: any): EconomicIndicators {
    const data = response.data || response;
   ...
   */
  private transformPostalCodeResponse(response: any): PostalCodeData {
    const data = response.data || response;
   ...
   */
  private transformDemographicResponse(response: any): any {
    const data = response.data || response;
   ...
   */
  private transformIncomeResponse(response: any): any {
    const data = response.data || response;
   ...
   */
  private parseLocation(postalCode: string): CanadianLocation {
