 ...
 */
export class CMHCDataSource implements DataSource {
  public readonly name = 'CMHC';
  public readonly baseUrl = 'https://api.cmhc-schl.gc.ca';
   ...
   */
  async getMortgageRates(): Promise<MortgageRates> {
   ...
   */
  async getMortgageRateTrends(period: string = '1year'): Promise<MortgageRates[]> {
   ...
   */
  async getRentalMarketData(region: string): Promise<RentalMarketData> {
   ...
   */
  async getHousingAffordability(postalCode: string): Promise<any> {
   ...
   */
  async getMarketAnalysis(region: string, reportType: string = 'quarterly'): Promise<any> {
   ...
   */
  async getHousingStarts(region: string): Promise<any> {
   ...
   */
  async getVacancyRates(region: string, propertyType: string = 'all'): Promise<any> {
   ...
   */
  async getHousingPriceIndices(region: string): Promise<any> {
   ...
   */
  private transformMortgageRatesResponse(response: any): MortgageRates {
   ...
   */
  private transformMortgageTrendsResponse(response: any): MortgageRates[] {
    const data = response.data || response;
   ...
   */
  private transformRentalMarketResponse(response: any): RentalMarketData {
    const data = response.data || response;
   ...
   */
  private transformAffordabilityResponse(response: any): any {
    const data = response.data || response;
   ...
   */
  private transformMarketAnalysisResponse(response: any): any {
    const data = response.data || response;
   ...
   */
  private transformHousingStartsResponse(response: any): any {
    const data = response.data || response;
   ...
   */
  private transformVacancyRatesResponse(response: any): any {
    const data = response.data || response;
   ...
   */
  private transformPriceIndicesResponse(response: any): any {
    const data = response.data || response;
   ...
   */
  async getMarketForecasts(region: string, timeframe: string = '1year'): Promise<any> {
